...
This repository contains all of the data and code necessary to reproduce the analyses described in the Shukla et al manuscript assessing how SARS-CoV and SARS-CoV-2 spikes utilize ACE2 or its variants during virus entry.


### Knitted Markdown file below
``` r
rm(list = ls())
